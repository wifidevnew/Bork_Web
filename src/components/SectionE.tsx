    ...
    <div className="justify-center xl:mt-[18rem] mt-[6rem]">
      <div ref={ref}>
        <div>
          ...
          <div className={`absolute 2xl:left-[57rem] xl:left-[52rem] xl:bottom-[20rem] rotate-45 fade-in bottom-[4rem] sm:left-[20rem] left-[10rem] md:left-[22rem] md:bottom-[7rem] lg:left-[29rem] animate ${inView ? 'fade-in' : ''}`}>
            <img
              src={bone}
              alt="Logo"
