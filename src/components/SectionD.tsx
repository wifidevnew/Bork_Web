...
const SectionD = () => {
  return (
    <div className="w-full justify-center flex 2xl:mt-[10rem] mt-[4rem]">
      <div className="mt-[1rem] 2xl:px-10 mb-10 px-4 lg:flex xl:flex 2xl:flex  2xl:gap-36 lg:gap-20  mx-auto rounded-3xl border-5 border-solid border-white bg-gradient-to-r from-slate-800 to-transparent">
