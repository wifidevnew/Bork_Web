...
const SectionDa = () => {
  ...
  return (
    <div className="container relative">
      <div className="w-full -mt-[22px] justify-center lg:flex lg:mt-[8rem] mb-[15rem] p-[12px] lg:p-0">
          ...
          <div className="rounded-3xl  bg-[#e8fcfc] lg:p-10 p-3 items-center gap-24">
              ...
              <div className="">
                <div className="text-[#1c3c89] grid grid-cols-2 lg:gap-2 gap-1 ">
                  <div className="flex flex-col">
                    <h1 className="-mb-2 " style={{ WebkitTextStrokeWidth: "1.5px", WebkitTextStrokeColor: "#182148", color: "#b0df04" }}>
                      BASE
                    </h1>
                    <span className="mt-0">Chain</span>
                  </div>
                  <div className="flex flex-col">
                    <h1 className="-mb-2 text-[26px] lg:text-[40px]" style={{ WebkitTextStrokeWidth: "1.5px", WebkitTextStrokeColor: "#182148", color: "#b0df04" }}>
                      Renounced
                    </h1>
                    <span>Contract</span>
                  </div>
            ...
            {showSmallItem && (
              <div className="">
                <div className="text-[#1c3c89] grid grid-cols-2 lg:gap-2 gap-1 ">
                  <div className="flex flex-col">
                    <h1 className="-mb-2 " style={{ WebkitTextStrokeWidth: "1px", WebkitTextStrokeColor: "#182148", color: "#b0df04" }}>
                      BASE
                    </h1>
                    <span className="mt-0">Chain</span>
                  </div>
                  <div className="flex flex-col">
                    <h1 className="-mb-2 text-[24px]" style={{ WebkitTextStrokeWidth: "1px", WebkitTextStrokeColor: "#182148", color: "#b0df04" }}>
                      Renounced
                    </h1>
                    <span>Contract</span>
                  </div>
                  <div className="flex flex-col">
                    <h1 className="-mb-2 " style={{ WebkitTextStrokeWidth: "1px", WebkitTextStrokeColor: "#182148", color: "#b4e804" }}>
                      1B
                    </h1>
                    <span>Suply</span>
                  </div>
                ...
                <div className="text-[#1c3c89]">
                  <h1 className="-mb-2  mt-10" style={{ WebkitTextStrokeWidth: "1px", WebkitTextStrokeColor: "#182148", color: "#b4e804" }}>
                    Contract
                  </h1>
                  <span>0xe48C3A357Dc4153bAEf2B86B7fF0d91837477A51</span>
                </div>
